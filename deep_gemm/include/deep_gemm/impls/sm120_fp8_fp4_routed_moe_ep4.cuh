...
#define SMEM_TB_SCR_STAGE_BYTES 18576
#define SMEM_TB_SCR_STRIDE 18576
...
DG_SM120_ROUTED_MOE_KERNEL(LoomTensorMap const* W1_A, LoomTensorMap const* W1_A64, LoomTensorMap const* W1_B, LoomTensorMap const* W1_SFA, LoomTensorMap const* W1_SFA64, LoomTensorMap const* W1_SFB, LoomTensorMap const* W1_D, LoomTensorMap const* W2_A, LoomTensorMap const* W2_A64, LoomTensorMap const* W2_B, LoomTensorMap const* W2_SFA, LoomTensorMap const* W2_SFA64, LoomTensorMap const* W2_SFB, LoomTensorMap const* W2_D, uint8_t* __restrict__ intermediate_fp8, uint8_t* __restrict__ intermediate_sfa_u8, int* __restrict__ requant_groups_done, int* __restrict__ w2_warp_done, int* __restrict__ w2_tiles_completed, int* __restrict__ topk_idx_i32, float* __restrict__ topk_weights, int* __restrict__ x_fp8_i32, int* __restrict__ x_sf_i32, int* __restrict__ owner_record_counts, int* __restrict__ owner_route_counts, int* __restrict__ owner_minexp_record_base, int* __restrict__ owner_minexp_record_cursor, int* __restrict__ sorted_record_token, int* __restrict__ sorted_record_route_base, int* __restrict__ route_result_index, int* __restrict__ protocol_error, unsigned long long* __restrict__ phase_timestamps, unsigned long long* __restrict__ peer_phase_timestamps, unsigned int* __restrict__ w2_task_counter, unsigned int* __restrict__ w1_task_counter, unsigned int* __restrict__ dispatch_chunk_scatter_counter, unsigned int* __restrict__ pull_chunk_arrived, unsigned int* __restrict__ result_owner_ready, unsigned int* __restrict__ result_owner_progress, unsigned long long* __restrict__ pull_request_scratch, int* __restrict__ dispatch_chunk_targets, int* __restrict__ c56_claim_cursor, int* __restrict__ combine_claim_cursor, int* __restrict__ c56_tile_mailbox, int* __restrict__ task_gate_packed, int* __restrict__ result_chunk_total, int* __restrict__ result_chunk_tally, int* __restrict__ result_ovf_cursor, unsigned long long* __restrict__ signal_base_scratch, unsigned long long* __restrict__ dispatch_chunk_signal_base_scratch, unsigned long long* __restrict__ result_signal_base_scratch, unsigned long long* __restrict__ ack_signal_base_scratch, __nv_bfloat16* __restrict__ final_output, unsigned int* __restrict__ pool_fp8_u32, unsigned int* __restrict__ pool_sf_u32, float* __restrict__ routing_weight_pool, int* __restrict__ meta_source_rank, int* __restrict__ meta_token, int* __restrict__ meta_slot, int* __restrict__ meta_result_index, int* __restrict__ expert_counts, int* __restrict__ owner_expert_route_counts, int* __restrict__ source_route_sum, int* __restrict__ source_expert_counts, int* __restrict__ expert_source_base, int* __restrict__ expert_source_offsets, int* __restrict__ source_expert_prefix, int* __restrict__ task_max_source, int* __restrict__ source_record_counts, int* __restrict__ source_route_counts, int* __restrict__ source_active_rows, int* __restrict__ expert_row_offsets, int* __restrict__ expert_task_base, int* __restrict__ expert_block_task, int* __restrict__ task_source_slot_base, int* __restrict__ expert_scatter_offsets, int* __restrict__ task_expert, int* __restrict__ task_source_rank, int* __restrict__ task_owner_rank, int* __restrict__ task_local_expert, int* __restrict__ task_pool_row, int* __restrict__ task_m_local, int* __restrict__ task_valid_m, int* __restrict__ task_rows_landed, int* __restrict__ total_valid_routes, int* __restrict__ total_padded_rows, int* __restrict__ total_m_tasks, int* __restrict__ histogram_done, int* __restrict__ prefix_done, int* __restrict__ w1_warp_done, int* __restrict__ w1_tiles_completed, int rank, int world_size, int active_rows, unsigned int epoch, ncclDevComm const* __restrict__ gin_dev_comm, uint8_t* __restrict__ dispatch_header_out, ncclWindow_t dispatch_header_out_window, uint8_t* __restrict__ dispatch_payload_out, ncclWindow_t dispatch_payload_out_window, uint8_t* __restrict__ dispatch_header_inbox, ncclWindow_t dispatch_header_inbox_window, uint8_t* __restrict__ dispatch_payload_inbox, ncclWindow_t dispatch_payload_inbox_window, uint8_t* __restrict__ result_out, ncclWindow_t result_out_window, uint8_t* __restrict__ result_inbox, ncclWindow_t result_inbox_window, uint8_t* __restrict__ ack_out, ncclWindow_t ack_out_window, uint8_t* __restrict__ ack_inbox, ncclWindow_t ack_inbox_window)
{
    ...
    int _max_1 = (((world_size * active_rows * 6 + 128 - 1) / 128 + 64) > (0) ? ((world_size * active_rows * 6 + 128 - 1) / 128 + 64) : (0));
    int _min_1 = ((_max_1) < (1600) ? (_max_1) : (1600));
    ...
    if (bid == 0 && warp == 0) {
        ...
        for (int tb_pass = 0; tb_pass < 2; tb_pass++) {
            ...
            if (active_rows >= 1024) {
                ...
                for (int tb_s = 0; tb_s < 4; tb_s++) {
                    tb_secs[tb_pass * 4 + tb_s] = 0;
                    tb_need[tb_pass * 4 + tb_s] = 0;
                    if (tb_s < world_size) {
                        tb_secs[tb_pass * 4 + tb_s] = source_expert_counts[tb_s * 64 + tb_e];
                        ...
                        tb_pf = _min_11;
                        tb_need[tb_pass * 4 + tb_s] = (tb_pf + tb_q - 1) / tb_q;
                    }
                }
                int es_run = 0;
                #pragma unroll
                for (int tb_s_1 = 0; tb_s_1 < 4; tb_s_1++) {
                    ...
                    for (int tb_s2 = 0; tb_s2 < 4; tb_s2++) {
                        if (tb_need[tb_pass * 4 + tb_s2] < tb_need[tb_pass * 4 + tb_s_1] || tb_need[tb_pass * 4 + tb_s2] == tb_need[tb_pass * 4 + tb_s_1] && tb_s2 < tb_s_1) {
                            tb_b = tb_b + tb_secs[tb_pass * 4 + tb_s2];
                        }
                    }
                    tb_base[tb_pass * 4 + tb_s_1] = tb_b;
                    expert_source_base[tb_e * 4 + tb_s_1] = tb_b;
                    es_run = es_run + tb_secs[tb_pass * 4 + tb_s_1];
                }
                if (es_run != tb_count) {
                    atomicMax(&protocol_error[0], 1);
                }
                ...
                for (int tb_m = 0; tb_m < tb_padded; tb_m += 128) {
                    ...
                    for (int tb_s_2 = 0; tb_s_2 < 4; tb_s_2++) {
                        if (tb_secs[tb_pass * 4 + tb_s_2] > 0 && tb_base[tb_pass * 4 + tb_s_2] < tb_m + 128 && tb_m < tb_base[tb_pass * 4 + tb_s_2] + tb_secs[tb_pass * 4 + tb_s_2]) {
                            int _max_12 = ((tb_key) > (tb_need[tb_pass * 4 + tb_s_2]) ? (tb_key) : (tb_need[tb_pass * 4 + tb_s_2]));
                            tb_key = _max_12;
                        }
                    }
                    #pragma unroll
                    for (int tb_s_3 = 0; tb_s_3 < 4; tb_s_3++) {
                        int _max_13 = ((tb_base[tb_pass * 4 + tb_s_3]) > (tb_m) ? (tb_base[tb_pass * 4 + tb_s_3]) : (tb_m));
                        int tb_lo = _max_13;
                        int _min_12 = ((tb_base[tb_pass * 4 + tb_s_3] + tb_secs[tb_pass * 4 + tb_s_3]) < (tb_m + 128) ? (tb_base[tb_pass * 4 + tb_s_3] + tb_secs[tb_pass * 4 + tb_s_3]) : (tb_m + 128));
                        int tb_hi = _min_12;
                        if (tb_hi > tb_lo) {
                ...
                for (int tb_k_2 = 0; tb_k_2 < 9; tb_k_2++) {
                    ...
                    tb_pre[tb_pass * 9 + tb_k_2] = tb_tot[tb_k_2] + tb_inc - tb_cnt[tb_k_2];
                ...
                for (int tb_k_3 = 0; tb_k_3 < 9; tb_k_3++) {
                    tb_below[tb_pass * 9 + tb_k_3] = tb_acc2;
                ...
                for (int m_local = 0; m_local < tb_padded; m_local += 128) {
                    ...
                    if (tb_task_idx < 1600) {
                        int _min_13 = ((m_local + 128) < (tb_count) ? (m_local + 128) : (tb_count));
                        int task_last_row = _min_13;
                        int task_ms = -1;
                        #pragma unroll 1
                        ...
                        int _min_14 = ((128) < (tb_count - m_local) ? (128) : (tb_count - m_local));
                        task_valid_m[tb_task_idx] = _min_14;
                        int task_gate = 0;
                        #pragma unroll 1
                        for (int gate_source = 0; gate_source < 4; gate_source++) {
                            if (gate_source < world_size && task_ms >= gate_source) {
                                ...
                                int _min_15 = ((_max_15) < (gate_count) ? (_max_15) : (gate_count));
                                gate_prefix = _min_15;
                        ...
                        expert_block_task[tb_e * 1600 + m_local / 128] = tb_task_idx;
                        #pragma unroll
                        for (int sb_source = 0; sb_source < 4; sb_source++) {
                            ...
                            int _min_16 = ((_max_16) < (sb_count) ? (_max_16) : (sb_count));
                            task_source_slot_base[tb_task_idx * 4 + sb_source] = source_expert_prefix[tb_e * 4 + sb_source] + _min_16;
                        }
                    } else {
                        atomicMax(&protocol_error[0], 1);
                    }
        ...
        if (active_rows >= 1024) {
            ...
            for (int tb_k_5 = 0; tb_k_5 < 9; tb_k_5++) {
                tb_kbase[tb_k_5] = tb_acc;
                tb_acc = tb_acc + tb_tot[tb_k_5];
            }
            __syncwarp();
            if (tb_lane == 0) {
                #pragma unroll
                for (int tb_s_5 = 0; tb_s_5 < 4; tb_s_5++) {
                    ...
                    for (int tb_k_6 = 0; tb_k_6 < 9; tb_k_6++) {
                        int tb_kt = tb_scr[4608 + tb_k_6 * 4 + tb_s_5];
                        tb_scr[4608 + tb_k_6 * 4 + tb_s_5] = tb_ka;
                        tb_ka = tb_ka + tb_kt;
                    }
                }
            }
            __syncwarp();
            #pragma unroll
            for (int tb_pass_1 = 0; tb_pass_1 < 2; tb_pass_1++) {
                int tb_e_1 = tb_pass_1 * 32 + tb_lane;
                int tb_count_1 = expert_counts[tb_e_1];
                int tb_padded_1 = (tb_count_1 + 128 - 1) / 128 * 128;
                int tb_row_base_1 = expert_row_offsets[tb_e_1];
                int tb_run[4];
                #pragma unroll
                ...
                int tb_prev_key = -1;
                #pragma unroll 1
                for (int m_local_1 = 0; m_local_1 < tb_padded_1; m_local_1 += 128) {
                    int tb_j = m_local_1 / 128;
                    int tb_key2 = 0;
                    int task_ms_1 = -1;
                    #pragma unroll
                    for (int tb_s_7 = 0; tb_s_7 < 4; tb_s_7++) {
                        if (tb_secs[tb_pass_1 * 4 + tb_s_7] > 0 && tb_base[tb_pass_1 * 4 + tb_s_7] < m_local_1 + 128 && m_local_1 < tb_base[tb_pass_1 * 4 + tb_s_7] + tb_secs[tb_pass_1 * 4 + tb_s_7]) {
                            int _max_17 = ((tb_key2) > (tb_need[tb_pass_1 * 4 + tb_s_7]) ? (tb_key2) : (tb_need[tb_pass_1 * 4 + tb_s_7]));
                            tb_key2 = _max_17;
                            int _max_18 = ((task_ms_1) > (tb_s_7) ? (task_ms_1) : (tb_s_7));
                            task_ms_1 = _max_18;
                        }
                    }
                    if (tb_key2 != tb_prev_key) {
                        #pragma unroll
                        for (int tb_s_8 = 0; tb_s_8 < 4; tb_s_8++) {
                            tb_run[tb_s_8] = 0;
                        }
                        tb_prev_key = tb_key2;
                    }
                    ...
                    for (int tb_k_7 = 0; tb_k_7 < 9; tb_k_7++) {
                        tb_sel = tb_sel + (int)(tb_key2 == tb_k_7) * (tb_kbase[tb_k_7] + tb_pre[tb_pass_1 * 9 + tb_k_7] - tb_below[tb_pass_1 * 9 + tb_k_7]);
                    }
                    int tb_task_idx_1 = build_shared_tasks + tb_sel + tb_j;
                    if (tb_task_idx_1 < 1600 && tb_j < 1600) {
                        expert_block_task[tb_e_1 * 1600 + tb_j] = tb_task_idx_1;
                        task_max_source[tb_task_idx_1] = task_ms_1;
                        task_expert[tb_task_idx_1] = rank * 64 + tb_e_1;
                        task_source_rank[tb_task_idx_1] = 0;
                        task_owner_rank[tb_task_idx_1] = rank;
                        task_local_expert[tb_task_idx_1] = tb_e_1;
                        task_pool_row[tb_task_idx_1] = tb_row_base_1 + m_local_1;
                        task_m_local[tb_task_idx_1] = m_local_1;
                        int _min_17 = ((128) < (tb_count_1 - m_local_1) ? (128) : (tb_count_1 - m_local_1));
                        task_valid_m[tb_task_idx_1] = _min_17;
                        task_gate_packed[tb_task_idx_1] = 0;
                        #pragma unroll
                        for (int tb_s_9 = 0; tb_s_9 < 4; tb_s_9++) {
                            int _max_19 = ((tb_base[tb_pass_1 * 4 + tb_s_9]) > (m_local_1) ? (tb_base[tb_pass_1 * 4 + tb_s_9]) : (m_local_1));
                            int tb_lo2 = _max_19;
                            int _min_18 = ((tb_base[tb_pass_1 * 4 + tb_s_9] + tb_secs[tb_pass_1 * 4 + tb_s_9]) < (m_local_1 + 128) ? (tb_base[tb_pass_1 * 4 + tb_s_9] + tb_secs[tb_pass_1 * 4 + tb_s_9]) : (m_local_1 + 128));
                            int tb_hi2 = _min_18;
                            int _max_20 = ((tb_hi2 - tb_lo2) > (0) ? (tb_hi2 - tb_lo2) : (0));
                            int tb_rows2 = _max_20;
                            task_source_slot_base[tb_task_idx_1 * 4 + tb_s_9] = tb_scr[4608 + tb_key2 * 4 + tb_s_9] + tb_scr[2304 + tb_e_1 * 36 + tb_key2 * 4 + tb_s_9] + tb_run[tb_s_9];
        ...
        __syncwarp();
        if (tb_lane == 0) {
            if (tb_valid_routes > 196608 || tb_total_padded > 204736 || tb_total_tasks > 1600) {
                atomicMax(&protocol_error[0], 1);
            }
    ...
    for (int pad_expert = 0; pad_expert < 64; pad_expert++) {
        ...
        if (pad_rows > 0) {
            ...
            for (int pad_sf = pad_tid; pad_sf < 32 * pad_rows; pad_sf += pad_threads) {
                ...
                pool_sf_u32[pad_sf_word * 204736 + pad_sf_row] = 0;
            }
        }
    }
    __threadfence();
                        ...
                        for (int record_route_2 = 0; record_route_2 < scatter_route_count; record_route_2++) {
                            ...
                            if (scatter_route_ok != 0) {
                                ...
                                if (lane == 0) {
                                    ...
                                    int _min_20 = ((_max_24 / 128) < (1599) ? (_max_24 / 128) : (1599));
                                    int sc_blk = _min_20;
                                    int sc_task = expert_block_task[scatter_local_expert * 1600 + sc_blk];
                                    ...
                                    if (scatter_claim < 0 || scatter_claim >= sc_source_count || dst_row < 0 || dst_row >= 204736) {
                                        ...
                                        int scatter_new_index = task_source_slot_base[sc_task * 4 + source_5] + (sc_rrow - _max_25);
                                        ...
                                        *(reinterpret_cast<int*>(reinterpret_cast<int*>(result_out) + ((unsigned long long)(source_5 * 2 + slot) * 102285312 + 102236160 + (unsigned long long)scatter_result_index)) + (0)) = scatter_new_index;
                                        ...
                                        int c41_sc_q = 128;
                                        if (c41_sc_r >= 768 && c41_sc_r < 3072 || c41_sc_r >= 8192) {
                                            c41_sc_q = 64;
                                        }
                                        if (c41_sc_r < 768) {
                                            c41_sc_q = 32;
                                ...
                                if (scatter_dst_row >= 0) {
                                    ...
                                    for (int scale_word_2 = lane; scale_word_2 < 32; scale_word_2 += 32) {
                                        pool_sf_u32[(unsigned long long)scale_word_2 * 204736 + (unsigned long long)scatter_dst_row] = (unsigned int)reinterpret_cast<const int*>(scatter_src_i32 + (src_scale_word + (unsigned long long)scale_word_2))[0];
                                    }
                                }
                                __syncwarp();
                            } else if (lane == 0) {
    ...
    if (bid > 0 && warp == 8) {
        ...
        #pragma unroll 1
        for (int c56_iter = 0; c56_iter < 102656; c56_iter++) {
            int c56_q = 0;
            if (elect_sync()) {
            ...
            if (c56_q >= c56_bound) {
                if (elect_sync()) {
                    int _atomic_old_4 = atomicAdd(&c56_tile_mailbox[c56_mb_base + 9], 2);
                    int c56_epi_old = _atomic_old_4;
            ...
            if (elect_sync()) {
                int _atomic_old_5 = atomicAdd(&c56_tile_mailbox[c56_mb_base + 9], 0);
                int c56_epi_flag = _atomic_old_5;
            ...
            if (u_pos < 32 && u_round < total_m_tasks[0]) {
                    ...
                    if (elect_sync()) {
                        if (w1_pool_row < 204736) {
                            ...
                            for (int w1_gate_spin = 0; w1_gate_spin < 1073741824; w1_gate_spin++) {
                                int _atomic_old_6 = atomicAdd(&task_rows_landed[w1_task], 0);
                                int w1_have_rows = _atomic_old_6;
                ...
                if (warp == 8) {
                    if (elect_sync()) {
                        int _atomic_old_7 = atomicAdd(&task_valid_m[w1_task], 0);
                        w1_short_a = (int)(_atomic_old_7 <= 64);
                    }
                }
                int _shfl_14 = __shfl_sync(0xFFFFFFFF, w1_short_a, 0);
                w1_short_a = _shfl_14;
                #pragma unroll 1
            ...
            if (u_pos >= 32 && u_round >= 4 && u_round < total_m_tasks[0] + 4) {
                ...
                if (warp == 8) {
                    if (elect_sync()) {
                        int _atomic_old_8 = atomicAdd(&task_valid_m[w2_task], 0);
                        w2_short_a = (int)(_atomic_old_8 <= 64);
                    }
                }
                int _shfl_15 = __shfl_sync(0xFFFFFFFF, w2_short_a, 0);
                w2_short_a = _shfl_15;
                #pragma unroll 1
    ...
    if (bid > 0 && warp < 8) {
        ...
        #pragma unroll 1
        for (int c56m_iter = 0; c56m_iter < 102656; c56m_iter++) {
            int c56m_val = 0;
            if (elect_sync()) {
                #pragma unroll 1
                for (int c56m_spin = 0; c56m_spin < 1073741824; c56m_spin++) {
                    int _atomic_old_9 = atomicAdd(&c56_tile_mailbox[c56m_mb_base + (c56m_seq & 3)], 0);
                    int c56m_probe = _atomic_old_9;
            ...
            if (u_pos_2 < 32 && u_round_2 < total_m_tasks[0]) {
                ...
                if (elect_sync()) {
                    if (w1_pool_row_2 < 204736) {
                        ...
                        for (int w1_gate_spin_2 = 0; w1_gate_spin_2 < 1073741824; w1_gate_spin_2++) {
                            int _atomic_old_10 = atomicAdd(&task_rows_landed[w1_task_2], 0);
                            int w1_have_rows_2 = _atomic_old_10;
                ...
                if (c56m_mode != 0) {
                    ...
                    for (int w1_fmt = 0; w1_fmt < 2; w1_fmt++) {
                        ...
                        if (w1_thread_id == 0) {
                            int w1_sf_index_0 = ((w1_req_group >> 2) * 204736 + w1_fused_row_0) * 4 + (w1_req_group & 3);
                            *(reinterpret_cast<unsigned char*>(intermediate_sfa_u8 + w1_sf_index_0) + (0)) = (unsigned char)(w1_sf_0_exp);
                            int w1_sf_index_1 = ((w1_req_group >> 2) * 204736 + w1_fused_row_1) * 4 + (w1_req_group & 3);
                    ...
                    if (elect_sync()) {
                        int _atomic_old_11 = atomicAdd(&w1_warp_done[w1_tile_2], 1);
                        int w1_previous = _atomic_old_11;
                        if (w1_previous == 7) {
            ...
            if (u_pos_2 >= 32 && u_round_2 >= 4 && u_round_2 < total_m_tasks[0] + 4) {
                ...
                if (c56m_mode != 0) {
                    ...
                    for (int w2_mt_2 = 0; w2_mt_2 < 2; w2_mt_2++) {
                        ...
                        for (int ce_r = 0; ce_r < 2; ce_r++) {
                            ...
                            if (ce_valid != 0) {
                                ...
                                int ce_rc = _min_31;
                                int ce_q = 128;
                                if (ce_rc >= 768 && ce_rc < 3072 || ce_rc >= 8192) {
                                    ce_q = 64;
                                }
                                if (ce_rc < 768) {
                                    ce_q = 32;
                                ...
                                if (ce_raw != 0 && w1_thread_id == 0) {
                                    int _atomic_old_12 = atomicAdd(&result_ovf_cursor[ce_src * 769 + ce_chunk], 1);
                                    ce_k = _atomic_old_12;
                                }
                            }
                            int _shfl_17 = __shfl_sync(0xFFFFFFFF, ce_k, w1_group_id * 4);
                            ce_k = _shfl_17;
                    ...
                    if (elect_sync()) {
                        int _atomic_old_13 = atomicAdd(&w2_warp_done[w2_tile_2], 1);
                        int w2_previous = _atomic_old_13;
                        if (w2_previous == 7) {
    ...
    if (bid > 0 && warp >= 9) {
        ...
        if (warp == 9) {
            if (elect_sync()) {
                int _atomic_old_14 = atomicAdd(&c56_tile_mailbox[epi_mb_base + 9], 1);
                int epi_old = _atomic_old_14;
        ...
        int epi_join = 0;
        if (elect_sync()) {
            int _atomic_old_15 = atomicAdd(&c56_tile_mailbox[epi_mb_base + 10], 0);
            epi_join = _atomic_old_15;
        }
        int _shfl_18 = __shfl_sync(0xFFFFFFFF, epi_join, 0);
        epi_join = _shfl_18;
        if ((epi_join & 2) == 0) {
            ...
            float epi_b[16];
            #pragma unroll 1
            for (int epi_iter = 0; epi_iter < 102657; epi_iter++) {
                mbarrier_wait(epi_full_addr, _phase_epi_full_0);
                _phase_epi_full_0 ^= 1;
                int epi_val = 0;
                if (elect_sync()) {
                    int _atomic_old_16 = atomicAdd(&c56_tile_mailbox[epi_mb_base + 8], 0);
                    epi_val = _atomic_old_16;
                }
                int _shfl_19 = __shfl_sync(0xFFFFFFFF, epi_val, 0);
                epi_val = _shfl_19;
                ...
                if (epi_pos < 32) {
                    ...
                    int e1_pool_row = 0;
                    if (elect_sync()) {
                        int _atomic_old_17 = atomicAdd(&task_pool_row[e1_task], 0);
                        e1_pool_row = _atomic_old_17;
                    }
                    int _shfl_20 = __shfl_sync(0xFFFFFFFF, e1_pool_row, 0);
                    e1_pool_row = _shfl_20;
                    #pragma unroll
                            ...
                            for (int e1_fmt = 0; e1_fmt < 2; e1_fmt++) {
                                ...
                                for (int e1_rq = 0; e1_rq < 4; e1_rq++) {
                                    ...
                                    for (int e1_rc = 0; e1_rc < 2; e1_rc++) {
                                        ...
                                        float _min_33 = fminf(e1_gate_0, 10.0f);
                                        e1_gate_0 = _min_33;
                                        float _max_45 = max_noftz(e1_up_0, -10.0f);
                                        float _min_34 = fminf(_max_45, 10.0f);
                                        e1_up_0 = _min_34;
                                        ...
                                        float _max_46 = max_noftz(e1_val_0, -e1_val_0);
                                        float _max_47 = max_noftz(e1_amax_0, _max_46);
                                        e1_amax_0 = _max_47;
                                        ...
                                        float _min_35 = fminf(e1_gate_1, 10.0f);
                                        e1_gate_1 = _min_35;
                                        float _max_48 = max_noftz(e1_up_1, -10.0f);
                                        float _min_36 = fminf(_max_48, 10.0f);
                                        e1_up_1 = _min_36;
                                        ...
                                        float _max_49 = max_noftz(e1_val_1, -e1_val_1);
                                        float _max_50 = max_noftz(e1_amax_1, _max_49);
                                        e1_amax_1 = _max_50;
                                    }
                                }
                                float _shfl_xor_8 = __shfl_xor_sync(0xFFFFFFFF, e1_amax_0, 2);
                                float _max_51 = max_noftz(e1_amax_0, _shfl_xor_8);
                                e1_amax_0 = _max_51;
                                float _shfl_xor_9 = __shfl_xor_sync(0xFFFFFFFF, e1_amax_0, 1);
                                float _max_52 = max_noftz(e1_amax_0, _shfl_xor_9);
                                e1_amax_0 = _max_52;
                                float _shfl_xor_10 = __shfl_xor_sync(0xFFFFFFFF, e1_amax_1, 2);
                                float _max_53 = max_noftz(e1_amax_1, _shfl_xor_10);
                                e1_amax_1 = _max_53;
                                float _shfl_xor_11 = __shfl_xor_sync(0xFFFFFFFF, e1_amax_1, 1);
                                float _max_54 = max_noftz(e1_amax_1, _shfl_xor_11);
                                e1_amax_1 = _max_54;
                                ...
                                unsigned int _min_37 = ((e1_sf_0_exp) < (254) ? (e1_sf_0_exp) : (254));
                                e1_sf_0_exp = _min_37;
                                ...
                                unsigned int _min_38 = ((e1_sf_1_exp) < (254) ? (e1_sf_1_exp) : (254));
                                e1_sf_1_exp = _min_38;
                                ...
                                if (epi_tid == 0) {
                                    int e1_sf_index_0 = ((e1_req_group >> 2) * 204736 + e1_row_0) * 4 + (e1_req_group & 3);
                                    *(reinterpret_cast<unsigned char*>(intermediate_sfa_u8 + e1_sf_index_0) + (0)) = (unsigned char)(e1_sf_0_exp);
                                    int e1_sf_index_1 = ((e1_req_group >> 2) * 204736 + e1_row_1) * 4 + (e1_req_group & 3);
                    ...
                    if (elect_sync()) {
                        ...
                        int _atomic_old_18 = atomicAdd(&w1_warp_done[e1_tile], e1_completion_count);
                        int e1_previous = _atomic_old_18;
                    ...
                    int e2_pool_row = 0;
                    if (elect_sync()) {
                        int _atomic_old_19 = atomicAdd(&task_pool_row[e2_task], 0);
                        e2_pool_row = _atomic_old_19;
                    }
                    int _shfl_21 = __shfl_sync(0xFFFFFFFF, e2_pool_row, 0);
                    e2_pool_row = _shfl_21;
                    #pragma unroll
                            ...
                            for (int e2_mt = 0; e2_mt < 2; e2_mt++) {
                                ...
                                for (int ce_r_1 = 0; ce_r_1 < 2; ce_r_1++) {
                                    ...
                                    for (int ce_kk0 = 0; ce_kk0 < 16; ce_kk0++) {
                                        ...
                                        unsigned int _max_55 = ((ce_emax_1) > (ce_e_1) ? (ce_emax_1) : (ce_e_1));
                                        ce_emax_1 = _max_55;
                                        unsigned int _min_39 = ((ce_emin_1) < (ce_e_1) ? (ce_emin_1) : (ce_e_1));
                                        ce_emin_1 = _min_39;
                                    }
                                    unsigned int _shfl_xor_12 = __shfl_xor_sync(0xFFFFFFFF, ce_emax_1, 1);
                                    unsigned int _max_56 = ((ce_emax_1) > (_shfl_xor_12) ? (ce_emax_1) : (_shfl_xor_12));
                                    ce_emax_1 = _max_56;
                                    unsigned int _shfl_xor_13 = __shfl_xor_sync(0xFFFFFFFF, ce_emax_1, 2);
                                    unsigned int _max_57 = ((ce_emax_1) > (_shfl_xor_13) ? (ce_emax_1) : (_shfl_xor_13));
                                    ce_emax_1 = _max_57;
                                    unsigned int _shfl_xor_14 = __shfl_xor_sync(0xFFFFFFFF, ce_emin_1, 1);
                                    unsigned int _min_40 = ((ce_emin_1) < (_shfl_xor_14) ? (ce_emin_1) : (_shfl_xor_14));
                                    ce_emin_1 = _min_40;
                                    unsigned int _shfl_xor_15 = __shfl_xor_sync(0xFFFFFFFF, ce_emin_1, 2);
                                    unsigned int _min_41 = ((ce_emin_1) < (_shfl_xor_15) ? (ce_emin_1) : (_shfl_xor_15));
                                    ce_emin_1 = _min_41;
                                    ...
                                    if (ce_valid_1 != 0) {
                                        ...
                                        int _max_58 = ((source_route_counts[ce_src_1]) > (0) ? (source_route_counts[ce_src_1]) : (0));
                                        int _min_42 = ((_max_58) < (49152) ? (_max_58) : (49152));
                                        int ce_rc_1 = _min_42;
                                        int ce_q_1 = 128;
                                        if (ce_rc_1 >= 768 && ce_rc_1 < 3072 || ce_rc_1 >= 8192) {
                                            ce_q_1 = 64;
                                        }
                                        if (ce_rc_1 < 768) {
                                            ce_q_1 = 32;
                                        }
                                        int _max_59 = (((ce_rc_1 + ce_q_1 - 1) / ce_q_1 - 1) > (0) ? ((ce_rc_1 + ce_q_1 - 1) / ce_q_1 - 1) : (0));
                                        int ce_full_1 = _max_59;
                                        ...
                                        if (ce_idx_1 < ce_ts_1) {
                                            ...
                                            int _min_43 = ((64) < (ce_rc_1 - ce_start_1) ? (64) : (ce_rc_1 - ce_start_1));
                                            ce_rows_1 = _min_43;
                                        }
                                        if (ce_raw_1 != 0 && epi_tid == 0) {
                                            int _atomic_old_20 = atomicAdd(&result_ovf_cursor[ce_src_1 * 769 + ce_chunk_1], 1);
                                            ce_k_1 = _atomic_old_20;
                                        }
                                    }
                                    int _shfl_22 = __shfl_sync(0xFFFFFFFF, ce_k_1, epi_gid * 4);
                                    ce_k_1 = _shfl_22;
                    ...
                    if (elect_sync()) {
                        int _atomic_old_21 = atomicAdd(&w2_warp_done[e2_tile], e2_completion_count);
                        int e2_previous = _atomic_old_21;
    ...
    if (bid == 0) {
        if (warp >= 1 && warp < world_size) {
            ...
            if (elect_sync()) {
                ...
                int _max_60 = (((map_records + 8 - 1) / 8) > (dispatch_chunk_min_records) ? ((map_records + 8 - 1) / 8) : (dispatch_chunk_min_records));
                int map_q = _max_60;
                ...
                int _max_61 = ((source_route_counts[map_source]) > (0) ? (source_route_counts[map_source]) : (0));
                int _min_44 = ((_max_61) < (49152) ? (_max_61) : (49152));
                int map_routes = _min_44;
                int _max_62 = ((map_routes) > (1) ? (map_routes) : (1));
                int map_count = _max_62;
                ...
                for (int h29_iter = 0; h29_iter < 3084; h29_iter++) {
                    ...
                    for (int h29_spin = 0; h29_spin < 1073741824; h29_spin++) {
                        int _atomic_old_22 = atomicAdd(&svc_qctl[2], 0);
                        int h29_done = _atomic_old_22;
                        __threadfence_block();
                        int _atomic_old_23 = atomicAdd(&svc_qctl[1], 0);
                        int h29_tail_seen = _atomic_old_23;
                    ...
                    if (h29_source == map_source) {
                        ...
                        int _max_63 = ((source_route_counts[h29_source]) > (0) ? (source_route_counts[h29_source]) : (0));
                        int _min_45 = ((_max_63) < (49152) ? (_max_63) : (49152));
                        int h29_routes = _min_45;
                        int h29_pq = 128;
                        if (h29_routes >= 768 && h29_routes < 3072 || h29_routes >= 8192) {
                            h29_pq = 64;
                        }
                        if (h29_routes < 768) {
                            h29_pq = 32;
                        }
                        int _max_64 = (((h29_routes + h29_pq - 1) / h29_pq - 1) > (0) ? ((h29_routes + h29_pq - 1) / h29_pq - 1) : (0));
                        int h29_pfull = _max_64;
                        ...
                        int _min_46 = ((h29_routes - h29_start) < (h29_cap) ? (h29_routes - h29_start) : (h29_cap));
                        int h29_chunk_rows = _min_46;
                        int _atomic_old_24 = atomicAdd(&result_ovf_cursor[h29_source * 769 + h29_chunk_local], 0);
                        int h29_ovf = _atomic_old_24;
                        ...
                        int _min_47 = ((h29_ovf) < (h29_chunk_rows * 16) ? (h29_ovf) : (h29_chunk_rows * 16));
                        int h29_put_bytes = h29_chunk_rows * 6272 + _min_47 * 128;
                        int _max_65 = ((owner_route_counts[h29_source]) > (0) ? (owner_route_counts[h29_source]) : (0));
                        int _min_48 = ((_max_65) < (49152) ? (_max_65) : (49152));
                        int c13a2_dual = (int)(h29_routes * 8 >= active_rows * 18 || h29_routes * 8 >= active_rows * 15 && _min_48 * 8 >= active_rows * 18);
                        __threadfence_system();
        ...
        if (warp == 0) {
            __syncwarp();
            int _max_66 = ((total_m_tasks[0]) > (0) ? (total_m_tasks[0]) : (0));
            int _min_49 = ((_max_66) < (1600) ? (_max_66) : (1600));
            int service_task_total = _min_49;
            int h20_tail = 0;
            #pragma unroll 1
                ...
                if (service_task < total_m_tasks[0]) {
                    ...
                    for (int service_row_offset_2 = lane; service_row_offset_2 < 128; service_row_offset_2 += 32) {
                        ...
                        if (service_source >= 0 && service_source < world_size) {
                            int _max_67 = ((source_route_counts[service_source]) > (0) ? (source_route_counts[service_source]) : (0));
                            int _min_50 = ((_max_67) < (49152) ? (_max_67) : (49152));
                            int c41_tr = _min_50;
                            int c41_tq = 128;
                            if (c41_tr >= 768 && c41_tr < 3072 || c41_tr >= 8192) {
                                c41_tq = 64;
                            }
                            if (c41_tr < 768) {
                                c41_tq = 32;
                            }
                            int _max_68 = (((c41_tr + c41_tq - 1) / c41_tq - 1) > (0) ? ((c41_tr + c41_tq - 1) / c41_tq - 1) : (0));
                            int c41_tfull = _max_68;
                            ...
                            int _atomic_old_25 = atomicAdd(&result_chunk_tally[service_chunk], 1);
                            int service_previous = _atomic_old_25;
                            int service_total = c41_tq;
                            if (service_chunk_local >= c41_tfull) {
                                int _min_51 = ((64) < (c41_tr - (c41_tts + (service_chunk_local - c41_tfull) * 64)) ? (64) : (c41_tr - (c41_tts + (service_chunk_local - c41_tfull) * 64)));
                                service_total = _min_51;
                            }
                                ...
                                for (int h20_full_spin = 0; h20_full_spin < 1073741824; h20_full_spin++) {
                                    ...
                                    for (int h29_cw = 1; h29_cw < 4; h29_cw++) {
                                        if (h29_cw < world_size) {
                                            int _atomic_old_26 = atomicAdd(&svc_qctl[3 + h29_cw], 0);
                                            int h29_cur = _atomic_old_26;
                                            int _min_52 = ((h20_consumed) < (h29_cur) ? (h20_consumed) : (h29_cur));
                                            h20_consumed = _min_52;
                                        }
                                    }
            ...
            if (elect_sync()) {
                ...
                for (int tail_source_i = 0; tail_source_i < 4; tail_source_i++) {
                    if (tail_source_i < world_size) {
                        ...
                        int _max_69 = ((source_route_counts[tail_source]) > (0) ? (source_route_counts[tail_source]) : (0));
                        int _min_53 = ((_max_69) < (49152) ? (_max_69) : (49152));
                        int tail_routes = _min_53;
                        ...
                        int c41_aq = 128;
                        if (tail_routes >= 768 && tail_routes < 3072 || tail_routes >= 8192) {
                            c41_aq = 64;
                        }
                        if (tail_routes < 768) {
                            c41_aq = 32;
                        }
                        int _max_70 = (((tail_routes + c41_aq - 1) / c41_aq - 1) > (0) ? ((tail_routes + c41_aq - 1) / c41_aq - 1) : (0));
                        int c41_afull = _max_70;
                        ...
                        for (int verify_chunk = 0; verify_chunk < tail_chunk_count; verify_chunk++) {
                            if (verify_chunk < 769) {
                                ...
                                if (c41_afull <= verify_chunk) {
                                    ...
                                    int _min_54 = ((64) < (tail_routes - verify_start) ? (64) : (tail_routes - verify_start));
                                    verify_total = _min_54;
                                }
                                ...
                                if (verify_tally < verify_total && tail_source != rank) {
                                    ...
                                    int _max_71 = ((owner_route_counts[tail_source]) > (0) ? (owner_route_counts[tail_source]) : (0));
                                    int _min_55 = ((_max_71) < (49152) ? (_max_71) : (49152));
                                    int c13a2_dual_v = (int)(tail_routes * 8 >= active_rows * 18 || tail_routes * 8 >= active_rows * 15 && _min_55 * 8 >= active_rows * 18);
                                    __threadfence_system();
    ...
    if (bid == 0 && warp >= 1 && warp < world_size) {
        ...
        if (elect_sync()) {
            ...
            int _max_72 = ((owner_routes) > (0) ? (owner_routes) : (0));
            int _min_56 = ((_max_72) < (49152) ? (_max_72) : (49152));
            int safe_owner_routes = _min_56;
            int c41_wq = 128;
            if (safe_owner_routes >= 768 && safe_owner_routes < 3072 || safe_owner_routes >= 8192) {
                c41_wq = 64;
            }
            if (safe_owner_routes < 768) {
                c41_wq = 32;
            }
            int _max_73 = (((safe_owner_routes + c41_wq - 1) / c41_wq - 1) > (0) ? ((safe_owner_routes + c41_wq - 1) / c41_wq - 1) : (0));
            int c41_wfull = _max_73;
            int _max_74 = ((c41_wfull + (safe_owner_routes - c41_wfull * c41_wq + 64 - 1) / 64) > (1) ? (c41_wfull + (safe_owner_routes - c41_wfull * c41_wq + 64 - 1) / 64) : (1));
            int owner_chunk_count = _max_74 + 1;
            #pragma unroll 1
            for (int h29_k = 1; h29_k < 771; h29_k++) {
                ...
                int c13a_c = h29_k - 2;
                int _max_75 = ((source_route_counts[wait_owner]) > (0) ? (source_route_counts[wait_owner]) : (0));
                int _min_57 = ((_max_75) < (49152) ? (_max_75) : (49152));
                int c13a2_dual_r = (int)(safe_owner_routes * 8 >= active_rows * 18 || safe_owner_routes * 8 >= active_rows * 15 && _min_57 * 8 >= active_rows * 18);
    ...
    for (int h37_iter = 0; h37_iter < 8193; h37_iter++) {
        int combine_token = 0;
        if (elect_sync()) {
            int _atomic_old_27 = atomicAdd(&combine_claim_cursor[0], 1);
            combine_token = _atomic_old_27;
        }
        int _shfl_23 = __shfl_sync(0xFFFFFFFF, combine_token, 0);
        combine_token = _shfl_23;
            ...
            if (meta_valid != 0) {
                ...
                if (meta_result_slot < 0 || meta_result_slot >= meta_owner_count) {
                    ...
                    if (meta_new_slot < 0 || meta_new_slot >= meta_owner_count) {
                        ...
                        int cd_rq = 128;
                        if (meta_owner_count >= 768 && meta_owner_count < 3072 || meta_owner_count >= 8192) {
                            cd_rq = 64;
                        }
                        if (meta_owner_count < 768) {
                            cd_rq = 32;
                        }
                        int _max_76 = (((meta_owner_count + cd_rq - 1) / cd_rq - 1) > (0) ? ((meta_owner_count + cd_rq - 1) / cd_rq - 1) : (0));
                        int cd_rfull = _max_76;
                        ...
                        if (meta_new_slot < cd_rts) {
                            ...
                            int _min_58 = ((64) < (meta_owner_count - cd_start) ? (64) : (meta_owner_count - cd_start));
                            cd_rows = _min_58;
                        }
                        if (meta_owner != rank) {
                            if (elect_sync()) {
            ...
            if (elect_sync()) {
                ...
                for (int h8_s = 0; h8_s < 4; h8_s++) {
                    if (h8_s < world_size) {
                        ...
                        int _max_77 = ((source_record_counts[h8_s]) > (0) ? (source_record_counts[h8_s]) : (0));
                        int _min_59 = ((_max_77) < (8192) ? (_max_77) : (8192));
                        int h8_count = _min_59;
                        int _max_78 = (((h8_count + 8 - 1) / 8) > (dispatch_chunk_min_records) ? ((h8_count + 8 - 1) / 8) : (dispatch_chunk_min_records));
                        int h8_q = _max_78;
                        ...
                        if (h8_s != rank) {
                            int _max_79 = ((owner_route_counts[h8_s]) > (0) ? (owner_route_counts[h8_s]) : (0));
                            int _min_60 = ((_max_79) < (49152) ? (_max_79) : (49152));
                            int h8_routes = _min_60;
                            int h8_rq = 128;
                            if (h8_routes >= 768 && h8_routes < 3072 || h8_routes >= 8192) {
                                h8_rq = 64;
                            }
                            if (h8_routes < 768) {
                                h8_rq = 32;
                            }
                            int _max_80 = (((h8_routes + h8_rq - 1) / h8_rq - 1) > (0) ? ((h8_routes + h8_rq - 1) / h8_rq - 1) : (0));
                            int h8_full = _max_80;
                            int _max_81 = ((h8_full + (h8_routes - h8_full * h8_rq + 64 - 1) / 64) > (1) ? (h8_full + (h8_routes - h8_full * h8_rq + 64 - 1) / 64) : (1));
                            int h8_owner_chunks = _max_81 + 1;
                            int h8_nchunks = h8_owner_chunks - 1;
                            int _max_82 = ((source_route_counts[h8_s]) > (0) ? (source_route_counts[h8_s]) : (0));
                            int _min_61 = ((_max_82) < (49152) ? (_max_82) : (49152));
                            if (h8_routes * 8 >= active_rows * 18 || h8_routes * 8 >= active_rows * 15 && _min_61 * 8 >= active_rows * 18) {
